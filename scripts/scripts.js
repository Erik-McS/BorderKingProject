...
function addLoggedButtons(){
    ...
    // array to store the buttons names
    let names=["Our Shop","Our Services","Contact Us","Account"];
    // array to store the corresponding ID
    let ids=["shopButton","servicesButton","contactButton","accountButton"];
    // array to store the function calling the corresponding page
    let page=["loadPage('shop')","loadPage('services')","loadPage('contact')","loadPage('custprofile')"];
